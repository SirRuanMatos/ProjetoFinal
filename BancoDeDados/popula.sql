...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Out-2019 às 19:26
...
INSERT INTO `aluno` (`idAluno`, `Nome`, `dataNascimento`, `genero`, `codLogin`) VALUES
(1, 'Elaine Lúcia da Mata', '0000-00-00', 'Feminino', 1),
(2, 'Larissa Ayla Dias', '0000-00-00', 'Feminino', 2),
(3, 'Kevin Cauê Bryan Barbosa', '0000-00-00', 'Masculino', 3),
(4, 'Caio Edson Davi da Costa', '0000-00-00', 'Masculino', 4),
(5, 'Isadora Raquel Ramos', '0000-00-00', 'Feminino', 5);

--
-- Extraindo dados da tabela `aula`
--

INSERT INTO `aula` (`idAula`, `codTurma`, `data`, `hora`, `local`) VALUES
(1, 1, '2019-10-01', '13:30', 'Compasso porto alegre'),
(2, 2, '2019-10-05', '16:00', 'Uniftec Caxias do sul'),
...
(6, 'carolinavalentinaisabellecosta-70@shimu.com.br', 'ACaSxZr28x', 0),
(7, 'alinevitoriaelisaporto_@opusvp.com.br', 'CbMgCTtGK7', 0),
(8, 'ceciliaesterisabellycosta_@dc4.com.br', 'RdP0SONPoQ', 0),
(9, 'claudialouiserocha-83@aulicinobastos.com.br', '25cqDNTbQE', 0),
(10, 'pedroandreryansouza_@dpi.ig.br', 'U7DCyihnLw', 0);
...
INSERT INTO `professor` (`idProfessor`, `nome`, `dataNascimento`, `genero`, `codLogin`) VALUES
(1, 'Carolina Valentina Isabelle Costa', '1984-05-14', 'Feminino', 6),
(2, 'Aline Vitória Elisa Porto', '1972-06-12', 'Feminino', 7),
(3, 'Cecília Ester Isabelly Costa', '1984-02-22', 'Feminino', 8),
(4, 'Cláudia Louise Rocha', '1943-08-02', 'Feminino', 9),
(5, 'Pedro André Ryan Souza', '1991-10-21', 'Masculino', 10);
